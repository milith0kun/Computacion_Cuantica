...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figuras/eda_iris.png}
\caption{Distribuci\'on de las muestras de Iris por pares de caracter\'isticas. Setosa (azul) es claramente separable.}
\label{fig:eda}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figuras/comparacion_general.png}
\caption{Izq: accuracy por modelo. Der: tiempo de entrenamiento (escala log). Azul = cl\'asico, morado = cu\'antico.}
...
La Figura~\ref{fig:frontera} muestra la frontera de decisi\'on del SVM-RBF en una proyecci\'on PCA bidimensional.

\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figuras/frontera_decision.png}
\caption{Frontera de decisi\'on del SVM-RBF en PCA 2D.}
\label{fig:frontera}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figuras/exp1_feature_maps.png}
\caption{Izq: accuracy por feature map. Der: curvas de convergencia de la funci\'on de p\'erdida.}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figuras/exp2_profundidad.png}
\caption{Izq: accuracy vs repeticiones del ansatz. Der: convergencia por profundidad.}
\label{fig:depth}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figuras/exp3_optimizadores.png}
\caption{Izq: accuracy por optimizador. Der: curvas de convergencia.}
\label{fig:optimizadores}
\end{figure}

\subsection{Kernel Cu\'antico vs Kernel RBF}
La Figura~\ref{fig:kernels} muestra los heatmaps de las matrices de kernel. El kernel cu\'antico exhibe una estructura m\'as dispersa y con mayor contraste.
...
El VQC se ejecut\'o con 5 semillas distintas, obteniendo un accuracy promedio de $0.484 \pm 0.076$ (Figura~\ref{fig:varianza}). Esta varianza alta contrasta con el SVM-RBF ($0.960 \pm 0.039$ en CV 5-fold).
...
En MNIST reducido (clases 0 vs 1), SVM-RBF alcanz\'o 100\% de accuracy mientras que VQC obtuvo 69.44\% (Figura~\ref{fig:mnist}). La tarea binaria es m\'as sencilla, pero el VQC a\'un no iguala al modelo cl\'asico.

\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figuras/exp_mnist.png}
\caption{Izq: accuracy SVM vs VQC en MNIST reducido. Der: convergencia del VQC.}
\label{fig:mnist}
\end{figure}
